...
def Transform_Wrist2Hand_np(
    ...
    t = np.array([0.0, -0.0165, -0.1105], dtype=np.float32)

    # pos_hand = pos_wrist - R_hand.dot(t)
    pos_hand = pos_wrist - R_hand @ t
...
def FK_Thumb_np(
    ...
    Finger_base = np.array([-0.01044496692, -0.02255, -0.05567929249], dtype=np.float32)
    ...
    MP_rot_to_Tip =MP_interm_link*right_direction+MP_rot
    MP_rot_rot=rotate_vector(MP_rot_to_Tip, -joint_angle[1], roll_axis)

    CMC_to_Tip = (link_1 - MP_interm_link) * right_direction + MP_rot_rot
...
def FK_Finger_np(
    ...
    MCP_base_to_Tip = link_0 * upright_direction + MCP_rot
    ...
    # if finger_type == "Index":
    #     print("finger_type: ", finger_type)
    #     print("joint_angles: ", joint_angles)
    #     print("R_hand: ", R_hand)
    #     print("hand_center: ", hand_pos)
    #     print("finger_base_pose: ", finger_base_pose)
    #     print("finger_x_axis: ", finger_x_axis)
    #     print("finger_y_axis: ", finger_y_axis)
    #     print("finger_z_axis: ", finger_z_axis)
    #     print("DIP_to_Tip: ", DIP_to_Tip)
    #     print("PIP_to_Tip: ", PIP_to_Tip)
    #     print("MCP_to_Tip: ", MCP_to_Tip)
    #     print("MCP_origin_to_Tip: ", MCP_origin_to_Tip)
