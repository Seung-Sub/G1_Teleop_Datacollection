...
def rotate_vector(v: np.ndarray, angle: float, axis: np.ndarray) -> np.ndarray:
    """
    Rotates a single 3D vector v around a given axis by a certain angle using Rodrigues' rotation formula.

    Args:
        v (np.ndarray): A 3D vector (shape: (3,))
        angle (float): Rotation angle in radians
        axis (np.ndarray): Rotation axis (shape: (3,))

    Returns:
        np.ndarray: The rotated 3D vector (shape: (3,))
    """
...
def cos2ndLaw_angle(side_length_1: float | np.ndarray, side_length_2: float | np.ndarray, far_length: float | np.ndarray) -> float | np.ndarray:
    """
...
def cos2ndLaw_length(side_length_1: float | np.ndarray, side_length_2: float | np.ndarray, angle_in_rad: float | np.ndarray) -> float | np.ndarray:
    """
